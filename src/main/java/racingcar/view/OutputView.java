...
public class OutputView extends Printer {
    ...
    private static final String INPUT_PROMPT_CARNAME = "경주할 자동차 이름을 입력하세요.(이름은 쉼표(,) 기준으로 구분)";
    private static final String INPUT_PROMPT_TRYCOUNT = "시도할 횟수는 몇 회인가요?";
    private static final String OUTPUT_PROMPT_WINNER = "최종 우승자 : ";
    private static final String OUTPUT_PROMPT_DISTANCE = "-";
